...
-A RDBMS is a Relational Database Management System, the software used to manage a database. SQL is the language used to interact with that system.

1. Why do tables need a `primary key`?

-A primary key is a unique data type used to identify an individual record within a database. 
...
-To have many to many relationships the tables need share a singular piece of unique data. 
